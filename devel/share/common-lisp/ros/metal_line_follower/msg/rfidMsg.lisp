...
(cl:defmethod nodeId-val ((m <rfidMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader metal_line_follower-msg:nodeId-val is deprecated.  Use metal_line_follower-msg:nodeId instead.")
  (nodeId m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<rfidMsg>)))
  ...
  "683ff0ffba5ff7be443d666ab4b04ae4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'rfidMsg)))
  "Returns md5sum for a message object of type 'rfidMsg"
  "683ff0ffba5ff7be443d666ab4b04ae4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<rfidMsg>)))
  ...
  (cl:format cl:nil "string sender~%string nodeId~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'rfidMsg)))
  "Returns full string definition for message of type 'rfidMsg"
  (cl:format cl:nil "string sender~%string nodeId~%~%~%"))
